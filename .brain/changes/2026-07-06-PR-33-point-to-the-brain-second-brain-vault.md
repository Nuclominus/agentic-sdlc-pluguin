...
# PR #33 — point to the .brain Second Brain vault

> `docs` · merged 2026-07-06 · by @Nuclominus

## Summary

Small discoverability pointer from the README to the `.brain/` vault. Doubles as the first real trigger of the `brain-sync` Action.
