...
# ADR-0023 — A project's SDLC files live in `.sdlc/`, not in a host's directory
...
1. **One directory, not one per host.** The obvious alternative was `.gemini/` on Antigravity,
   ...
   [[decisions/ADR-0022-one-ssot-emitted-host-packages]] §6 deliberately keeps tier tags
...
- Relates to: [[decisions/ADR-0022-one-ssot-emitted-host-packages]] /
