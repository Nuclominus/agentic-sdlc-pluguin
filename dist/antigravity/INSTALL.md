...
| android-foundation | `hooks/hooks.json#PreToolUse:config-protection.sh` | its matcher names Claude Code tool(s) Edit, Write, which host antigravity spells differently and declares no tool-name map for — registered, it would guard nothing while reading as coverage |
