...
3. **Read `<project>/.sdlc/sdlc.local.yaml`, if it exists, for `frameworks.disable`** (ADR-0027).
...
Override with: /sdlc:start --stack=NAME "<feature>"  ·  suppress a framework via frameworks.disable in .sdlc/sdlc.local.yaml
```
