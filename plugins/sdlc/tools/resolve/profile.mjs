...
/**
 * Every top-level key `.claude/sdlc.local.yaml` may legitimately carry.
 *
...
export function applyLocalOverrides(profile, local, opts = {}) {
  ...
  for (const key of Object.keys(local)) {
    ...
    warnings.push(`WARN: .claude/sdlc.local.yaml: unknown key '${key}' — ignored. Supported: ${[...KNOWN_LOCAL_KEYS].sort().join(", ")}`);
  }
